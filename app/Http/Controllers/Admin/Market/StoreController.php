...
class StoreController extends Controller
{
    ...
    public function store(StoreRequest $request,Product $product)
    {
        ...
        $product->update([
            'marketable_number'=>$product->marketable_number+$request->marketable_number,
        ]);

        return redirect()->route('admin.market.store.index')->with('swal-success','موجودی با موفقیت افزایش یافت');
    }
    ...
    public function update(StoreUpdateRequest $request, Product $product)
    {
        ...
        return redirect()->route('admin.market.store.index')->with('swal-success','موجودی با موفقیت اصلاح یافت');
    }
