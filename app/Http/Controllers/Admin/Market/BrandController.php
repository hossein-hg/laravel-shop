...
class BrandController extends Controller
{
    ...
    public function store(BrandRequest $request, ImageService $imageService)
    {
        ...
        if ($request->hasFile('logo')){
            ...
            if (!$result)
            {
                return redirect()->route('admin.market.brand.index')->with('swal-success','آپلود تصویر با مشکل مواجه شد');
            }
        ...
        return redirect()->route('admin.market.brand.index')->with('toast-success','برند جدید با موفقیت ثبت شد');
    }
