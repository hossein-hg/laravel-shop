...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect()->route('admin.user.role.index')->with('swal-success','نقش با موفقیت اضافه شد');
    ...
    {
        $permissions = Permission::all();
        return view('admin.user.role.permission-role',compact(['role','permissions']));
    }
