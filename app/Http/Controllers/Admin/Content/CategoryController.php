...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $post_categories = PostCategory::query()->latest()->simplePaginate(15);
    ...
    public function store(PostCategoryRequest $request, ImageService $imageService)
    {
       ...
       if ($request->hasFile('image')){
           ...
           if (!$result)
           {
               return redirect()->route('admin.content.category.index')->with('swal-success','آپلود تصویر با مشکل مواجه شد');
           }
           $inputs['image'] = $result;

       }

       $category = PostCategory::query()->create($inputs);
