                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($postCategories as $category)
                            ...
                            <tr id="tr{{$category->id}}">
                                ...
                                <td>{{$category->tags}} </td>
                                <td><label for="">
                                        <input data-url="{{route('admin.content.category.status',[$category->id])}}" id="{{$category->id}}" type="checkbox" {{$category->status == 1 ? 'checked' : ''}} onchange="changeStatus({{$category->id}})">
                                    </label> </td>
                                <td class="width-16-rem text-left justify-content-end">
                                    ...
                                    <a  id="delete{{$category->id}}" onclick="deleteRecord({{$category->id}})" data-url="{{route('admin.content.category.destroy',[$category->id])}}" class="btn btn-danger btn-sm text-white"><i class="fa fa-edit"></i> حذف</a>
