                    ...
                    @foreach($payments as $key => $payment)
                        <tr>
                            ...
                            <td class="width-22-rem text-left">
                                ...
                                <a href="{{route('admin.market.payment.canceled',[$payment->id])}}" class="btn btn-warning btn-sm  @if($payment->status == 2) disabled  @endif"><i class="fa fa-close"></i> باطل کردن</a>
                                <a href="{{route('admin.market.payment.returned',[$payment->id])}}" class="btn btn-danger btn-sm @if($payment->status == 3) disabled  @endif"><i class="fa fa-reply"></i> برگرداندن</a>
                            </td>
                        </tr>
                        @endforeach
