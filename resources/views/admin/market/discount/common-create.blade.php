                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="discount_ceiling" name="discount_ceiling" type="text" class="form-control form-control-sm" value="{{old('discount_ceiling')}}">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="minimal_order_amount" name="minimal_order_amount" type="text" class="form-control form-control-sm" value="{{old('minimal_order_amount')}}">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{old('title')}}" id="title" name="title" type="text" class="form-control form-control-sm">
                                @error('title')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
