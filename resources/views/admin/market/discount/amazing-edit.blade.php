                    ...
                    <section class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_id" class="form-control form-control-sm" id="">
                                    ...
                                    @foreach($products as $product)
                                        <option value="{{$product->id}}" {{old('product_id',$amazingSale->product_id) == $product->id ? 'selected' : ''}}>{{$product->name}}</option>
                                    @endforeach
                                </select>
                                @error('product_id')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="percentage" type="text" class="form-control form-control-sm" value="{{old('percentage',$amazingSale->percentage)}}">
                                @error('percentage')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
