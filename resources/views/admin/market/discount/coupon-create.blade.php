                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user" class="form-control form-control-sm" disabled>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="amount_type" id="amount_type" class="form-control form-control-sm">
                                    <option @if(old('amount_type') == 0) selected @endif value="0">درصدی</option>
                                    <option @if(old('amount_type') == 1) selected @endif value="1">عددی</option>
                                </select>
                                @error('amount_type')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
