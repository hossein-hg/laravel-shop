    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section >
                    <form action="{{route('admin.market.discount.couponStore')}}" method="post">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="amount_type"  type="text" class="form-control form-control-sm">
                                        <option {{old('amount_type') == 0 ? 'selected' : ''}} value="0">درصدی</option>
                                        <option {{old('amount_type') == 1 ? 'selected' : ''}} value="1">مقداری</option>
                                    </select>
                                    @error('amount_type')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="type" name="type"  type="text" class="form-control form-control-sm">
                                        <option {{old('type') == 0 ? 'selected' : ''}} value="0">عمومی</option>
                                        <option {{old('type') == 1 ? 'selected' : ''}} value="1">خصوصی</option>
                                    </select>
                                    @error('type')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="user_id" disabled name="user_id"  type="text" class="form-control form-control-sm">
