                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="name" value="{{old('name',$categoryAttribute->name)}}">
                                @error('name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="unit" value="{{old('unit',$categoryAttribute->unit)}}">
                                @error('unit')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="category_id" id="" class="form-control form-control-sm" >
                                    ...
                                    <option @if(old('category_id',$categoryAttribute->category_id) == $category->id) selected  @endif value="{{$category->id}}">{{$category->name}}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                <span class="text-danger">{{$message}}</span>
