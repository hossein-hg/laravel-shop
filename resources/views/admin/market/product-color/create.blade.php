  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form id="form" action="{{route('admin.market.product-color.store',[$product->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{old('color_name')}}" id="name" type="text" name="color_name" class="form-control form-control-sm @error('color_name') border-danger @enderror">
                                @error('color_name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{old('price_increase')}}" id="name" type="text" name="price_increase" class="form-control form-control-sm @error('price_increase') border-danger @enderror">
