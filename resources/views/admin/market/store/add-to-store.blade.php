                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{old('receiver')}}" name="receiver" type="text" class="form-control form-control-sm">
                                @error('receiver')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{old('deliverer')}}" name="deliverer" type="text" class="form-control form-control-sm">
                                @error('deliverer')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
