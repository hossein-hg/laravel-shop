        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 pt-2 border-bottom">
                    <a href="{{route('admin.market.color.create',[$product->id])}}" class="btn btn-info btn-sm ">ایجاد رنگ</a>
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover ">
                        ...
                        <tr id="tr{{$color->id}}" class="height-95px">
                            <th>{{++$key}}</th>
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <a  id="delete{{$color->id}}" onclick="deleteRecord({{$color->id}})" data-url="{{route('admin.market.color.destroy',[$color->id])}}" class="btn btn-danger btn-sm text-white"><i class="fa fa-edit"></i> حذف</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
