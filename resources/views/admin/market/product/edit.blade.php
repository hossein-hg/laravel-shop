  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{route('admin.market.product.update',[$product->id])}}" enctype="multipart/form-data" method="post" id="form">
                    @csrf
                    @method('put')
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="tags" value="{{old('tags',$product->tags)}}" type="hidden" name="tags" class="form-control form-control-sm ">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="published_at" name="published_at" class="form-control form-control-sm d-none"  value="{{old('published_at',$product->published_at)}}">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="introduction" id="body"  class="form-control form-control-sm" rows="6">{{old('introduction',$product->introduction)}}</textarea>
                                @error('introduction')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <section class="col-12 border-top border-bottom py-3 mb-3">
                            ...
                            <section class="row">
                                ...
                                <section class="col-6 col-md-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name="meta_key[]" value="{{$meta->meta_key}}">
                                        @error('meta_key.*')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <section class="col-6 col-md-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" name="meta_value[]" value="{{$meta->meta_value}}">
                                        @error('meta_value.*')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
