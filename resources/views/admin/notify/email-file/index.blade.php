                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($email->files as $key =>$file)
                            <tr>
                                ...
                                <td>
                                    <label for="">
                                        <input id="{{$file->id}}" type="checkbox" @if($file->status == 1) checked @endif onchange="changeStatus({{$file->id}})" data-url="{{route('admin.notify.email-file.status',[$file->id])}}">
                                    </label>
                                </td>
                                <td class="width-16-rem text-left d-flex">
                                    ...
                                    <form method="post" action="{{route('admin.notify.email-file.destroy',[$file->id])}}">
                                        @csrf
                                        @method('delete')
