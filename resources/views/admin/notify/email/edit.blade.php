                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="subject" value="{{old('subject',$email->subject)}}" type="text" class="form-control form-control-sm">
                                    @error('subject')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{old('published_at',$email->published_at)}}"  id="published_at" name="published_at" type="hidden" class="form-control form-control-sm">
                                    <input value="{{old('published_at',$email->published_at)}}"  id="published_at_view"  type="text" class="form-control form-control-sm">
                                    @error('published_at')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <section class="col-12 ">
                                <div class="form-group">
                                    ...
                                    <textarea name="body"  type="text" id="body" class="form-control form-control-sm">{{old('body',$email->body)}}</textarea>
                                    @error('body')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
