                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control form-control-sm" name="first_name" value="{{old('first_name',$customer->first_name)}}">
                                @error('first_name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="last_name" type="text" class="form-control form-control-sm" name="last_name" value="{{old('last_name',$customer->last_name)}}">
                                @error('last_name')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="activation" id="" class="form-control form-control-sm">
                                    <option @if(old('activation',$customer->activation) == 0) selected @endif value="0">غیر فعال</option>
                                    <option @if(old('activation',$customer->activation) == 1) selected @endif value="1">فعال</option>
                                </select>
                                @error('activation')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
