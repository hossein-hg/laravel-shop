                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($post_categories as $category)
                        <tr>
                            ...
                            <td>
                                <label for="">
                                    <input id="{{$category->id}}" type="checkbox" @if($category->status == 1) checked @endif onchange="changeStatus({{$category->id}})" data-url="{{route('admin.content.category.status',[$category->id])}}">
                                </label>
                            </td>
                            ...
                            <td class="width-16-rem d-flex  text-left">
                                ...
                                <form method="post" action="{{route('admin.content.category.destroy',[$category->id])}}">
                                    @method('delete')
                                    @csrf
