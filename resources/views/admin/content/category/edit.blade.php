                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{old('name',$postCategory->name)}}" id="name" type="text" name="name" class="form-control form-control-sm @error('name') border-danger @enderror">
                                    @error('name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="tags" value="{{old('tags',$postCategory->tags)}}" type="hidden" name="tags" class="form-control form-control-sm @error('tags') border-danger @enderror">
