  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form id="form" action="{{ route('admin.content.faq.update',[$faq->id]) }}" method="post">
                    @csrf
                    @method('put')
                    <section class="row">
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="answer" id="body"  class="form-control form-control-sm" rows="6">{{old('answer',$faq->answer)}}</textarea>
                                @error('answer')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <section class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="tags" value="{{old('tags',$faq->tags)}}" type="hidden" name="tags" class="form-control form-control-sm ">
