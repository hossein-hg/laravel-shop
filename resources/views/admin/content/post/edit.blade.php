                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input id="title" value="{{old('title',$post->title)}}" type="text" class="form-control form-control-sm" name="title">
                                @error('title')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="published_at" name="published_at" class="form-control form-control-sm d-none"  value="{{old('published_at',$post->published_at)}}">
                        ...
                        <section class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input id="tags" value="{{old('tags',$post->tags)}}" type="hidden" name="tags" class="form-control form-control-sm ">
