        ...
        <section class="d-flex justify-content-between">
            ...
            <section>
                    <span class="ml-2 ml-md-4 position-relative">
                        <span data-url="{{route('admin.notification.readAll')}}" id="header-notification-toggle" class="pointer">
                ...
                <span class="ml-2 ml-md-4 position-relative">
                    ...
                    <section id="header-comment" class="header-comment">
                        ...
                        <section class="header-comment-wrapper">
                            <ul class="list-group rounded px-0">
                                @foreach($unseenComments as $unseen)
                                <li class="list-group-item list-groupt-item-action">
                                    <section class="media">
                                        ...
                                        <section class="media-body pr-1">
                                            <section class="d-flex justify-content-between">
                                                <h5 class="comment-user">{{$unseen->user->fullName}} </h5>
                                                <span>{{$unseen->body}}<i class="fas fa-circle text-success comment-user-status"></i></span>
                                            </section>
                                        </section>
                                    </section>
                                </li>
