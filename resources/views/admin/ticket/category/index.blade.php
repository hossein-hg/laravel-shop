                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($categories as $key => $category)
                            ...
                            <tr id="tr{{$category->id}}">
                                ...
                                <td>
                                    <label for="">
                                        <input data-url="{{route('admin.ticket.category.status',[$category->id])}}" id="{{$category->id}}" type="checkbox" {{$category->status == 1 ? 'checked' : ''}} onchange="changeStatus({{$category->id}})">
                                    </label>
                                </td>
                                <td class="width-16-rem text-left justify-content-end">
                                    <a href="{{route('admin.ticket.category.edit',[$category->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                    <a  id="delete{{$category->id}}" onclick="deleteRecord({{$category->id}})" data-url="{{route('admin.ticket.category.destroy',[$category->id])}}" class="btn btn-danger btn-sm text-white"><i class="fa fa-edit"></i> حذف</a>
