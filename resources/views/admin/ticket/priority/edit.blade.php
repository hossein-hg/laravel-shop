    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form id="form" action="{{route('admin.ticket.priority.update',[$priority->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{old('name',$priority->name)}}" id="name" type="text" name="name" class="form-control form-control-sm @error('name') border-danger @enderror">
                                    @error('name')
