        ...
        <section class="top-header">
            <section class="container-xxl ">
                <section class="d-flex justify-content-between align-items-center py-3">
                    <section class=""><a class="text-decoration-none" href="index.blade.php"><img src="assets/images/logo/8.png" alt="logo"></a></section>
    ...
    <main id="main-body-one-col" class="main-body">
                        ...
                        <section class="lazyload-wrapper" >
                            <section class="lazyload light-owl-nav owl-carousel owl-theme">
                                ...
                                <section class="item">
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            <section class="product-add-to-cart"><a class="product-add-to-cart-active" href="#" data-bs-toggle="tooltip" data-bs-placement="left" title="افزودن به سبد خرید"><i class="fa fa-cart-plus"></i></a></section>
                                            <section class="product-add-to-favorite"><a class="product-add-to-favorite-active" href="#" data-bs-toggle="tooltip" data-bs-placement="left" title="افزودن به علاقه مندی"><i class="fa fa-heart"></i></a></section>
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="" src="assets/images/products/2.jpg" alt="">
                                                </section>
        ...
        <section class="">
            <section class="container-xxl">
                ...
                <!-- four column-->
                <section class="row py-4">
                    <section class="col"><img class="d-block rounded-2 w-100" src="assets/images/ads/four-col-1.jpg" alt=""></section>
                    <section class="col"><img class="d-block rounded-2 w-100" src="assets/images/ads/four-col-2.jpg" alt=""></section>
                    <section class="col"><img class="d-block rounded-2 w-100" src="assets/images/ads/four-col-3.jpg" alt=""></section>
                    <section class="col"><img class="d-block rounded-2 w-100" src="assets/images/ads/four-col-4.jpg" alt=""></section>
                </section>
            </section>
        </section>
        <!-- end ads section -->
