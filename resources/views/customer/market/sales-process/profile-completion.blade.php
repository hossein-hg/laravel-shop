                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            <form id="profile_completion" action="{{ route('customer.profile-completion.update') }}" method="post" class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                @csrf
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted"><span  id="total_product_price">{{ \App\Helpers\priceFormat($totalProductPrice) }}</span> تومان</p>
                                </section>

                                @if($totalDiscount != 0)
                                    <section class="d-flex justify-content-between align-items-center">
                                        <p class="text-muted">تخفیف کالاها</p>
                                        <p class="text-danger fw-bolder"><span id="total_discount">{{ \App\Helpers\priceFormat($totalDiscount) }}</span> تومان</p>
                                    </section>
                                @endif
                                <section class="border-bottom mb-3"></section>
                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">جمع سبد خرید</p>
                                    <p class="fw-bolder"><span id="total_price">{{ \App\Helpers\priceFormat($totalProductPrice - $totalDiscount) }}</span> تومان</p>
                                </section>
