        ...
        <section class="row">
            <section class="col-md-8 pe-1">
                <section id="slideshow" class="owl-carousel owl-theme">
                    ...
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="#"><img class="w-100 rounded-2 d-block h-auto" src="{{asset('customer-assets/images/slideshow/6.jpg')}}" alt=""></a></section>
                </section>
            </section>
            <section class="col-md-4 ps-1">
                ...
                <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2" src="{{asset('customer-assets/images/slideshow/11.gif')}}" alt=""></a></section>
            </section>
        </section>
    </section>
    <!-- end slideshow -->
